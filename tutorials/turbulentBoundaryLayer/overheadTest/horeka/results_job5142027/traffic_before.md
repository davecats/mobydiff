...
## /hkfs/work/workspace/scratch/xt8786-roughBoundaryLayer/optimiseBlockRefinement/moby-2to1-run/results_ab/before/nsys_rect_jacobi_r4N1/rep_0.sqlite

Steady window = 28.8 steps
...
## /hkfs/work/workspace/scratch/xt8786-roughBoundaryLayer/optimiseBlockRefinement/moby-2to1-run/results_ab/before/nsys_refined_yp82_rect_jacobi_r4N1/rep_0.sqlite
...
| `pressure_solver_compute_rdenom` | 3.0 | 15.9 | 1,511,368 | 3 B x3, 8 B x13, 272 B x0, 136,012,800 B x0 |
| `ibmm_update_ibm_mu` | 3.0 | 9.8 | 78 | 8 B x10 |
| `bodyforce_fill_trip_kernel` | 3.0 | 10.0 | 816 | 8 B x6, 192 B x4 |
| `step_add_bodyforce_correction` | 3.0 | 1.0 | 8 | 8 B x1 |
| `step_get_timestep_rates` | 1.0 | 13.0 | 104 | 8 B x13 |
