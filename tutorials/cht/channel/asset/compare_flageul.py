...
"""Detailed comparison against Flageul et al.'s RAW data (not the digitised plot).
    ...
    ./compare_flageul.py [--stats flageul_clean.h5] [--out flageul_detail.png]
...
def main():
    ...
    # the CLEAN window; flageul_stats.h5 is the contaminated one (see README)
    ap.add_argument("--stats", default=os.path.join(HERE, "flageul_clean.h5"))
    ap.add_argument("--vel", default=os.path.join(HERE, "Cstat_vel.h5"))
