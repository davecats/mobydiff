...
S3 lockdown: skew-symmetric convection is the hardwired production form
(docs/next_session_skew_convection.md). Decomposition splits x
...
def main():
    ...
    xz = a.refine_dims == "xz"
    name = a.name or ("xz" if xz else "noreflux" if a.no_reflux else "default")
    t_end = a.t_transient + a.t_average
    skew_sub = []   # S3 lockdown: skew-symmetric convection is hardwired
